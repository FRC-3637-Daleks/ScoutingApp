...
function createNewMatchTag() {
  ...
  '<td><img id="editIcon-'+tagId+'" src="../images/pencil.png" style="width:24px;height:24px;" onClick="editTag(\''+tagId+'\',\'match\');"><img id="saveIcon-'+tagId+'" src="../images/save.png" style="width:24px;height:24px;display:none;" onClick="saveTag(\''+tagId+'\');"></td>' +
...
function createNewTeamTag() { 
   var tagId = newTagId -1;
   var newRow = '<tr id="row-'+tagId+'">' +
  '<td><img id="editIcon-'+tagId+'" src="../images/pencil.png" style="width:24px;height:24px;" onClick="editTag(\''+tagId+'\',\'team\');"><img id="saveIcon-'+tagId+'" src="../images/save.png" style="width:24px;height:24px;display:none;" onClick="saveTag(\''+tagId+'\');"></td>' +
  '<td><div id="tag-'+tagId+'"></div><div id="tag-edit-'+tagId+'" style="display:none;"><input  id="tag-edit-input-'+tagId+'"  type="text"></input></div></td>' +
  '<td><div id="grouping-'+tagId+'"></div><div id="grouping-edit-'+tagId+'" style="display:none;"><select  id="grouping-edit-input-'+tagId+'"></select></div></td>' +
  '<td><div id="category-'+tagId+'"></div><div id="category-edit-'+tagId+'" style="display:none;"><input  id="category-edit-input-'+tagId+'"  type="text"></input></div></td>' +
  '<td><div id="inputType-'+tagId+'"></div><div id="inputType-edit-'+tagId+'" style="display:none;"><select  id="inputType-edit-input-'+tagId+'"></select></div></td>' +
...
<table class = "tagTable" id="matchTags"> 
  ...
  <td><img id="editIcon-${matchTag.id}" src="../images/pencil.png" style="width:24px;height:24px;" onClick="editTag(${matchTag.id},'match');"><img id="saveIcon-${matchTag.id}" src="../images/save.png" style="width:24px;height:24px;display:none;" onClick="saveTag(${matchTag.id});"></td>
...
<table class = "tagTable" id="teamTags">
  ...
  <td><img id="editIcon-${teamTag.id}" src="../images/pencil.png" style="width:24px;height:24px;" onClick="editTag(${teamTag.id}, 'team');"><img id="saveIcon-${teamTag.id}" src="../images/save.png" style="width:24px;height:24px;display:none;" onClick="saveTag(${teamTag.id});"></td>
